...
JAVA_OPTS="-Xms2g -Xmx26g -XX:MetaspaceSize=96M -XX:MaxMetaspaceSize=256m -Djava.net.preferIPv4Stack=true -Xdebug -Xrunjdwp:transport=dt_socket,address=*:8787,server=y,suspend=n"
...
-p 8080:8080 -p 8787:8787 -e JAVA_OPTS="$JAVA_OPTS" -d $WILDFLY_IMAGE
