...
[[ -z "$genomic_dataset_s3_object_key" ]] && missing+=("--genomic_dataset_s3_object_key or GENOMIC_DATASET_S3_OBJECT_KEY")
[[ -z "$dataset_s3_object_key" ]] && missing+=("--dataset_s3_object_key or DATASET_S3_OBJECT_KEY")
[[ -z "$environment_name" ]] && missing+=("--environment_name or ENVIRONMENT_NAME")
