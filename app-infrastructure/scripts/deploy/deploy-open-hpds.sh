...
[[ -z "$destigmatized_dataset_s3_object_key" ]] && missing+=("--destigmatized_dataset_s3_object_key or DESTIGMATIZED_DATASET_S3_OBJECT_KEY")
...
-p 8080:8080 \
-e JAVA_OPTS=" -XX:+UseParallelGC -XX:SurvivorRatio=250 -Xms10g -Xmx28g -Dserver.port=8080 -Dspring.profiles.active=open -DCACHE_SIZE=2500 -DSMALL_TASK_THREADS=1 -DLARGE_TASK_THREADS=1 -DSMALL_JOB_LIMIT=100 -DID_BATCH_SIZE=5000 " \
-d "$HPDS_IMAGE"
