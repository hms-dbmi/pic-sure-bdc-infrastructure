...
sudo mkdir /usr/local/docker-config/search/
...
sudo docker run --name=dictionary -v /var/log/dictionary-docker-logs/:/usr/local/tomcat/logs/ -v /usr/local/docker-config/search/dictionary.javabin:/usr/local/docker-config/search/dictionary.javabin -p 8080:8080 -d $DICTIONARY_IMAGE
