...
s3_copy "s3://${stack_s3_bucket}/configs/jenkins_pipeline_build_${stack_githash}/deploy-httpd.sh" "/home/centos/deploy-httpd.sh"
...
sudo /home/centos/deploy-httpd.sh --stack_s3_bucket "${stack_s3_bucket}" --stack_githash "${stack_githash}"
