...
bdc_add="$repo_root/app-infrastructure/db/bdc/auth/V25__Add_Banner_Management_Access_Rule.sql"
bdc_expand="$repo_root/app-infrastructure/db/bdc/auth/V26__Expand_Banner_Management_Access_Rule.sql"
bdc_reorder="$repo_root/app-infrastructure/db/bdc/auth/V27__Authorize_Banner_Reorder.sql"
bdc_disable="$repo_root/app-infrastructure/db/bdc/auth/V28__Allow_Banner_Disable_Route.sql"
bdc_archive="$repo_root/app-infrastructure/db/bdc/auth/V29__Allow_Banner_Archive_Route.sql"
bdc_restore="$repo_root/app-infrastructure/db/bdc/auth/V30__Allow_Banner_Restore_Route.sql"
aim_add="$repo_root/app-infrastructure/db/aim-ahead/auth/V27__Add_Banner_Management_Access_Rule.sql"
aim_expand="$repo_root/app-infrastructure/db/aim-ahead/auth/V28__Expand_Banner_Management_Access_Rule.sql"
aim_reorder="$repo_root/app-infrastructure/db/aim-ahead/auth/V29__Authorize_Banner_Reorder.sql"
aim_disable="$repo_root/app-infrastructure/db/aim-ahead/auth/V30__Allow_Banner_Disable_Route.sql"
aim_archive="$repo_root/app-infrastructure/db/aim-ahead/auth/V31__Allow_Banner_Archive_Route.sql"
aim_restore="$repo_root/app-infrastructure/db/aim-ahead/auth/V32__Allow_Banner_Restore_Route.sql"
